...
func newSessionRepositoryTest(t *testing.T, jwtExp int) (*SessionRepository, *redisinfra.RedisAdapter) {
	t.Helper()
	server := miniredis.RunT(t)
	redisAdapter, err := redisinfra.NewRedisAdapter(&config.AppConfig{
