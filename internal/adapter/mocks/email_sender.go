...
func (_m *MockEmailSender) Send(_a0 []string, _a1 string, _a2 string) error {
...
//   - _a1 string
//   - _a2 string
func (_e *MockEmailSender_Expecter) Send(_a0 interface{}, _a1 interface{}, _a2 interface{}) *MockEmailSender_Send_Call {
	return &MockEmailSender_Send_Call{Call: _e.mock.On("Send", _a0, _a1, _a2)}
}

func (_c *MockEmailSender_Send_Call) Run(run func(_a0 []string, _a1 string, _a2 string)) *MockEmailSender_Send_Call {
...
func (_c *MockEmailSender_Send_Call) RunAndReturn(run func([]string, string, string) error) *MockEmailSender_Send_Call {
	_c.Call.Return(run)
	return _c
}
