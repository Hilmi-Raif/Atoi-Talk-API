...
import (
	service "AtoiTalkAPI/internal/api/application"
...
func (c *AdminController) BanUser(w http.ResponseWriter, r *http.Request) {
	...
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		response.WriteError(w, helper.NewBadRequestError(""))
		return
	}
...
func (c *AdminController) UnbanUser(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		response.WriteError(w, helper.NewBadRequestError("Invalid User ID"))
		return
	}
...
func (c *AdminController) GetReports(w http.ResponseWriter, r *http.Request) {
	...
	if limitStr != "" {
		...
		if err != nil {
			response.WriteError(w, helper.NewBadRequestError("Invalid limit"))
			return
		}
		limit = l
	}
	...
	response.WriteSuccessWithPagination(w, reports, nextCursor, hasNext)
}
...
func (c *AdminController) GetReportDetail(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		response.WriteError(w, helper.NewBadRequestError("Invalid Report ID"))
		return
	}
	...
	response.WriteSuccess(w, report)
}
...
func (c *AdminController) GetUsers(w http.ResponseWriter, r *http.Request) {
	...
	response.WriteSuccessWithPagination(w, data, nextCursor, hasNext)
}
...
func (c *AdminController) ResetUserInfo(w http.ResponseWriter, r *http.Request) {
	...
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		response.WriteError(w, helper.NewBadRequestError("Invalid request body"))
		return
	}
	...
	if err != nil {
		response.WriteError(w, helper.NewBadRequestError("Invalid user ID URL"))
		return
	}
	req.TargetUserID = targetID

	if err := c.validator.Struct(req); err != nil {
		response.WriteError(w, helper.NewBadRequestError(err.Error()))
		return
	}
...
func (c *AdminController) GetGroupDetail(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		response.WriteError(w, helper.NewBadRequestError("Invalid Chat ID"))
		return
	}
...
func (c *AdminController) GetGroupMembers(w http.ResponseWriter, r *http.Request) {
	...
	response.WriteSuccessWithPagination(w, members, nextCursor, hasNext)
}
